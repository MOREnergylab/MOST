...
%% Mooring LUT
moor_LUT.X=-20:2.5:20;                       % Surge positions at which mooring loads are computed
moor_LUT.Y=-5:2.5:5;                         % Sway positions at which mooring loads are computed
moor_LUT.Z=-7.5:2.5:7.5;                     % Heave positions at which mooring loads are computed
moor_LUT.RX=deg2rad(-5:2.5:5);               % Roll rotations at which mooring loads are computed
moor_LUT.RY=deg2rad(-7.5:2.5:7.5);           % Pitch rotations at which mooring loads are computed
moor_LUT.RZ=deg2rad(-5:2.5:5);               % Yaw rotations at which mooring loads are computed
%% Flag
