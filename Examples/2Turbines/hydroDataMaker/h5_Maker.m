...
if 1
    ...
    if 1
    %% Locations
    data.geom.locations=[0  150 0 ;% pos_x -- pos_y -- rot_z
                         0 -150 0].*[1 1 pi/180];
    %% Body 1
    data.geom.Body1.Rupper=3.25;
    data.geom.Body1.Rlower=4.7;
    data.geom.Body1.Hupper=14;
    data.geom.Body1.Hlower=108;
    data.geom.Body1.Hcone=8; 
    data.geom.Body1.Freeboard=10;
    data.geom.Body1.t=0.025;
    data.geom.Body1.Perc_waterBallast=70; %(70% water, 30% sand)
    data.geom.Body1.Maxsize_Nemoh=4; 
    data.geom.Body1.Minsize_Nemoh=2;  
    data.geom.Body1.Platform_Name='Spar5MW'; 
    data.geom.Body1.PythonScriptName='Spar.py';
    %% Body 2
    data.geom.Body2.D_MC=10;
    data.geom.Body2.D_EC=12.5;
    data.geom.Body2.Draft=20;
    data.geom.Body2.FB=15;
    data.geom.Body2.L_EXT=51.75;
    data.geom.Body2.W_ARM=12.5;
    data.geom.Body2.H_ARM=7;
    data.geom.Body2.W_BR=4;
    data.geom.Body2.H_BR=4;
    data.geom.Body2.t_MC=0.03;
    data.geom.Body2.t_EC=0.0275;
    data.geom.Body2.t_AR=0.0275;
    data.geom.Body2.t_BR=0.025;
    data.geom.Body2.Maxsize_Nemoh=4;
    data.geom.Body2.Minsize_Nemoh=2;
    data.geom.Body2.Platform_Name='VolturnUS';
    data.geom.Body2.PythonScriptName='VolturnUS.py';
    end
    %% TURBINE DATA
    data.WTcomponents.Body1.filepath=[fileparts(pwd) filesep 'mostData' filesep 'windTurbine' ...
        filesep 'turbine_properties' filesep 'Properties_NREL5MW.mat'];

    data.WTcomponents.Body2.filepath=[fileparts(pwd) filesep 'mostData' filesep 'windTurbine' ...
    ...
    data.mooring.Body1.filepath=[fileparts(pwd) filesep 'mostData' filesep 'mooring' ...
        filesep 'Mooring_NREL5MW_Spar.mat'];

    data.mooring.Body2.filepath=[fileparts(pwd) filesep 'mostData' filesep 'mooring' ...
        filesep 'Mooring_IEA15MW_VolturnUS.mat'];
    %% SALOME
    data.salome.SALOME_path=['C:', filesep, 'SALOME-9.9.0'];   
    %% NEMOH
    data.nemoh.frequencies=[68 2*pi*[0.025  1]]; % rad/s
    data.nemoh.wavedir=[1 0 0];
    data.nemoh.symmetric=0; % flag (0/1)
    data.nemoh.results_folder_name='2Turbines_Results'; 
    %% BEMIO
