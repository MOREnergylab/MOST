...
close all
%% SETTING
plot_flags.external_inputs=[1 0 0]; % Wind - Wave Elevation - Wave Spectrum
...
plot_flags.controlled_inputs=[1 1 1]; % Generator Torque (low speed shaft) - Blade pitch - DeltaYaw
