...
filename_InputTurbsim='TurbsimInputFile.txt';      % Name of the main TurbSim input file
deleteOut=true;                                    % Flag to choose if temporary Turbsim output files must be deleted
%% MAIN
